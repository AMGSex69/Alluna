				...
				<div className="max-w-[100%] mx-auto px-4 sm:px-6 lg:px-8">
					<div className="flex justify-between items-center h-16">
						...
						<div className="flex items-center md:flex-row md:space-x-2 flex-col">
							<Button variant="outline" size="sm" onClick={handleShare} className="relative bg-transparent md:min-w-auto min-w-[120px]">
								{copied ? (
									<>
							...
							<Button variant="outline" size="sm" onClick={handleDownload} className="md:min-w-auto min-w-[120px]">
								<ExternalLink className="h-4 w-4 md:mr-2" />
								<span className="hidden md:inline">{document.file_url ? "Открыть документ" : "Скачать PDF"}</span>
							</Button>
