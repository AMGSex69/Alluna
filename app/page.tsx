          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                <strong>Режим тестирования:</strong> Приложение использует
                тестовые данные (без Supabase). Интегрирована поддержка OkiDoki
                API для Email подписания документов.
                <br />
                Для включения Supabase удалите{" "}
                <code>NEXT_PUBLIC_USE_MOCK_DATA=true</code> из .env.local
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                <strong>Требуется настройка базы данных:</strong> Пожалуйста,
                выполните SQL скрипт для создания таблиц. Перейдите в настройки
                проекта и запустите скрипт{" "}
                <code>scripts/001_create_projects_table.sql</code>
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Управляйте своими дизайн-проектами и документами
              </p>
            </div>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className="md:opacity-0 opacity-100 md:group-hover:opacity-100 transition-opacity p-1 hover:bg-red-50 rounded"
          ...
          {projects.length === 0 && !dbError && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                Создайте свой первый дизайн-проект для начала работы
              </p>
            </div>
          )}
        </div>
